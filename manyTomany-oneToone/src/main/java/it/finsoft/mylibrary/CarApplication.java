...
public class CarApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
        ...
        Engine en2 = new Engine("high");//so now we create 3 objects(movie) with one attribute
        Engine en3 = new Engine("low","high");
        Engine en4 = new Engine("high","high");//other attributes we put empty 
        //md1.setDuration(60);
        engines.add(en1);//this we need because in this way we put our created objects in  our list otherwise list still is empty
        engines.add(en2);
        engines.add(en3);
        engines.add(en4);
        ...
        engineRepository.save(engines);// u should be carefull of order of this 2 otherwise error "transient unsaved" will appear 
        								//later I understood that by using transaction annotation this problem is solved.
